  ...
  */
  ...
  export type PlayerGetPayload<S extends boolean | null | undefined | PlayerArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'senders' ? Array < FriendshipGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'receivers' ? Array < FriendshipGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'chat_rooms' ? Array < PermissionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'all_messages' ? Array < MessageGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    : S extends { select: any } & (PlayerArgs | PlayerFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'senders' ? Array < FriendshipGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'receivers' ? Array < FriendshipGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'chat_rooms' ? Array < PermissionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'all_messages' ? Array < MessageGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type ChatRoomGetPayload<S extends boolean | null | undefined | ChatRoomArgs, U = keyof S> =
    ...
    ? ChatRoom  & {
    [P in TrueKeys<S['include']>]:
        P extends 'all_members' ? Array < PermissionGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'all_messages' ? Array < MessageGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    : S extends { select: any } & (ChatRoomArgs | ChatRoomFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'all_members' ? Array < PermissionGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'all_messages' ? Array < MessageGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type PermissionGetPayload<S extends boolean | null | undefined | PermissionArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'chat_room' ? ChatRoomGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'chat_room' ? ChatRoomGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Permission ? Permission[P] : never
  } 
      : Permission
  ...
  export type MessageGetPayload<S extends boolean | null | undefined | MessageArgs, U = keyof S> =
    ...
    ? Message  & {
    [P in TrueKeys<S['include']>]:
        P extends 'sender' ? PlayerGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'room' ? ChatRoomGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : S extends { select: any } & (MessageArgs | MessageFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'sender' ? PlayerGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'room' ? ChatRoomGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Message ? Message[P] : never
  } 
      : Message
  ...
  export type FriendshipGetPayload<S extends boolean | null | undefined | FriendshipArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'sender' ? PlayerGetPayload<Exclude<S['include'], undefined | null>[P]> :
        P extends 'receiver' ? PlayerGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : S extends { select: any } & (FriendshipArgs | FriendshipFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'sender' ? PlayerGetPayload<Exclude<S['select'], undefined | null>[P]> :
        P extends 'receiver' ? PlayerGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Friendship ? Friendship[P] : never
  } 
      : Friendship
  ...
  export type PermissionWhereInput = {
    ...
    blocked_since?: DateTimeFilter | Date | string
    muted_until?: DateTimeFilter | Date | string
  ...
  export type PermissionScalarWhereWithAggregatesInput = {
    ...
    blocked_since?: DateTimeWithAggregatesFilter | Date | string
    muted_until?: DateTimeWithAggregatesFilter | Date | string
  ...
  export type PermissionUpdateInput = {
    ...
    blocked_since?: DateTimeFieldUpdateOperationsInput | Date | string
    muted_until?: DateTimeFieldUpdateOperationsInput | Date | string
